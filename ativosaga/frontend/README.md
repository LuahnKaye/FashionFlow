# 🎨 AtivoSAGA - Frontend Experience

Este é o cliente web do ecossistema **AtivoSAGA**. Uma interface de alta costura projetada para oferecer uma experiência de compra fluida, rápida e visualmente impactante.
